...
- 1.0.01	- Начало.
- 1.0.02	- Релиз.
- 1.0.03	- Устраненая проблема с возможностью установить температуру нагрева выше порога, заданного в maxHeatSetpoint. Откорректирован конвертор на предмет проброса термостата в Home Assistant. Добавлены функции callback в структуру DataPoint'ов. Протестирован термостат с игнатурой `_TZE204_aoclfnxz`.
